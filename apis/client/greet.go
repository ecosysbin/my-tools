...
func (c *TestApiClient) AddUserHandler(ctx context.Context, req AddUserRequest) (*AddUserResponse, error) {
	...
	reqObj, err := http.NewRequestWithContext(ctx, "POST", fullURL, bytes.NewBuffer(reqBody))
	if err != nil {
		return nil, fmt.Errorf("failed to create POST request to %s: %w", fullURL, err)
	}
...
func (c *TestApiClient) DeleteUserHandler(ctx context.Context, req DeleteUserRequest) (*DeleteUserResponse, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("failed to create DELETE request to %s: %w", fullURL, err)
	}
...
func (c *TestApiClient) UpdateUserHandler(ctx context.Context, req UpdateUserRequest) (*UpdateUserResponse, error) {
	...
	reqObj, err := http.NewRequestWithContext(ctx, "PUT", fullURL, bytes.NewBuffer(reqBody))
	if err != nil {
		return nil, fmt.Errorf("failed to create PUT request to %s: %w", fullURL, err)
	}
...
func (c *TestApiClient) GetUserHandler(ctx context.Context, req GetUserRequest) (*GetUserResponse, error) {
	...
	// 创建HTTP GET请求
	reqObj, err := http.NewRequestWithContext(ctx, "GET", fullURL, nil)
	if err != nil {
		return nil, fmt.Errorf("failed to create GET request to %s: %w", fullURL, err)
	}
