...
func FilterRoutersOptions(routers []string) framework.MiddlewareInterfaceOptions {
	return func(c *gcpctx.GCPContext) bool {

		for _, router := range routers {
			if strings.Contains(c.Request.URL.Path, router) {
				return true
			}
		}
