...
import (
	...
	"vcluster-gateway/cmd/app/config"
	"vcluster-gateway/cmd/app/options"
	"vcluster-gateway/pkg/controller"
	"vcluster-gateway/version"
)

func NewVclusterGatewayCommand() *cobra.Command {
	cmd := &cobra.Command{
		Use: "vcluster-gateway",
	}
