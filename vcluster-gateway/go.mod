...
require (
	...
	github.com/conductor-sdk/conductor-go v1.3.9
	github.com/dgraph-io/ristretto v0.1.1
	github.com/endverse/go-kit v0.2.0
	...
	github.com/loft-sh/vcluster v0.18.1
	...
	gitlab.datacanvas.com/AlayaNeW/OSM/gokit v0.1.2
